...
/**
 * Wraps a Swift `(_ event: String) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_std__string {
  public typealias bridge = margelo.nitro.localwebview.bridge.swift

  private let closure: (_ event: String) -> Void

  public init(_ closure: @escaping (_ event: String) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(event: std.string) -> Void {
    self.closure(String(event))
  }
