...
/**
 * Represents the React Native `ViewManager` for the "LocalWebView" Nitro HybridView.
 */
public class HybridLocalWebViewManager: SimpleViewManager<View>() {
  init {
    if (RecyclableView::class.java.isAssignableFrom(LocalWebView::class.java)) {
  ...
  override fun createViewInstance(reactContext: ThemedReactContext): View {
    val hybridView = LocalWebView(reactContext)
  ...
  override fun updateState(view: View, props: ReactStylesDiffMap, stateWrapper: StateWrapper): Any? {
    ...
    HybridLocalWebViewStateUpdater.updateViewProps(hybridView, stateWrapper)
  ...
  private fun getHybridView(view: View): LocalWebView? {
    return view.getTag(associated_hybrid_view_tag) as? LocalWebView
  }
}
