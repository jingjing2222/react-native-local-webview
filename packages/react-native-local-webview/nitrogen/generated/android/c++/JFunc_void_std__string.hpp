...
namespace margelo::nitro::localwebview {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/localwebview/Func_void_std__string;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/localwebview/Func_void_std__string_cxx;";
